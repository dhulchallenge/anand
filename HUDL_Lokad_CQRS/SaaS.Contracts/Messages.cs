...
namespace SaaS
{
    ...
    /// </summary>
    [DataContract(Namespace = "Lokad.SaaS")]
    public partial class CreateBooking : ICommand<BookId>
    {
        [DataMember(Order = 1)]
        ...
        CreateBooking() { }
        public CreateBooking(BookId id, Rental rental)
        {
            Id = id;
            Rent = rental;
        }
        ...
        public override string ToString()
        {
            return string.Format(@"Create booking {0}", Id);
        }
    }


    [DataContract]
    public partial class CarRentalMaster
    {

        [DataMember(Order = 1)]
        public int Availabitiy { get; set; }
    ...
    /// </summary>
    [DataContract(Namespace = "Lokad.SaaS")]
    public partial class BookingCreated : IEvent<BookId>
    {
        [DataMember(Order = 1)]
        public BookId Id { get; private set; }
        [DataMember(Order = 2)]
        ...
        BookingCreated() { }
        public BookingCreated(BookId id, Rental rent)
        {
            Id = id;
            Rent = rent;
        }
